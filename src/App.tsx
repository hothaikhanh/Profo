...
import "./App.scss";
import type { BGTextConfig, CameraConfigs, ScreenConfigs, SiteData } from "./types";
...
const App = () => {
    ...
    const [data] = useState<SiteData>(localizationData);
            ...
            {pageReady && (
                <div className="nav-bar">
                    ...
                    <button
                        className={"lang-btn"}
                        onClick={() => {
                            setLocale && setLocale(locale == "EN" ? "VN" : "EN");
                        }}
                    >
