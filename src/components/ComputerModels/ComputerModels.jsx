...
export default function ComputerModels({ scale, position }) {
    ...
    // const { nodes, materials } = useGLTF("/src/assets/old_computers/old_computers.glb");
    // return (
    //     <group scale={scale} position={position} dispose={null}>
    //         <group position={[0.27, 1.529, -2.613]}>
    //             <mesh castShadow receiveShadow geometry={nodes.Object_206.geometry} material={materials.Texture} />
    //             <mesh castShadow receiveShadow geometry={nodes.Object_207.geometry} material={materials.Screen} />
    //         </group>
    //         <group position={[-1.43, 2.496, -1.8]} rotation={[0, 1.002, 0]}>
    //             <mesh castShadow receiveShadow geometry={nodes.Object_209.geometry} material={materials.Texture} />
    //             <mesh castShadow receiveShadow geometry={nodes.Object_210.geometry} material={materials.Screen} />
    //         </group>
    //         <group position={[-2.731, 0.629, -0.522]} rotation={[0, 1.087, 0]}>
    //             <mesh castShadow receiveShadow geometry={nodes.Object_212.geometry} material={materials.Texture} />
    //             <mesh castShadow receiveShadow geometry={nodes.Object_213.geometry} material={materials.Screen} />
    //         </group>
    //         <group position={[1.845, 0.377, -1.771]} rotation={[0, -Math.PI / 9, 0]}>
    //             <mesh castShadow receiveShadow geometry={nodes.Object_215.geometry} material={materials.Texture} />
    //             <mesh castShadow receiveShadow geometry={nodes.Object_216.geometry} material={materials.Screen} />
    //         </group>
    ...
    //             <mesh castShadow receiveShadow geometry={nodes.Object_219.geometry} material={materials.Screen} />
    //         </group>
    //         <group position={[-3.417, 3.056, 1.303]} rotation={[0, 1.222, 0]} scale={0.9}>
    //             <mesh castShadow receiveShadow geometry={nodes.Object_221.geometry} material={materials.Texture} />
    //             <mesh castShadow receiveShadow geometry={nodes.Object_222.geometry} material={materials.Screen} />
    //         </group>
    //         <group position={[-3.899, 4.287, -2.642]} rotation={[0, 0.539, 0]}>
    //             <mesh castShadow receiveShadow geometry={nodes.Object_224.geometry} material={materials.Texture} />
    //             <mesh castShadow receiveShadow geometry={nodes.Object_225.geometry} material={materials.Screen} />
    //         </group>
    //         <group position={[0.992, 4.287, -4.209]} rotation={[0, 0.429, 0]} scale={[-1, 1, 1]}>
    //             <mesh castShadow receiveShadow geometry={nodes.Object_227.geometry} material={materials.Texture} />
    //             <mesh castShadow receiveShadow geometry={nodes.Object_228.geometry} material={materials.Screen} />
    //         </group>
    //         <group position={[4.683, 4.29, -1.558]} rotation={[0, -Math.PI / 3, 0]}>
    //             <mesh castShadow receiveShadow geometry={nodes.Object_230.geometry} material={materials.Texture} />
    //             <mesh castShadow receiveShadow geometry={nodes.Object_231.geometry} material={materials.Screen} />
    //         </group>
    //         <mesh
    //             castShadow
    //             receiveShadow
...
// useGLTF.preload("/src/assets/old_computers/old_computers.glb");
