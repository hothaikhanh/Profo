...
export default function ProjectListPage({ data, skills, bottomFrameHeight, goBack, handleCloseApp }) {
        ...
        <div className="mobile project-list-page">
            ...
            {selectedProject === null ? (
                ...
                <>
                    ...
                    <div className="navigation" style={{ paddingBottom: bottomFrameHeight * 0.15 }}>
